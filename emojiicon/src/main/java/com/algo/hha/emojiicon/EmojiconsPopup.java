...
package com.algo.hha.emojiicon;
...
import com.algo.hha.emojiicon.emoji.Nature;
import com.algo.hha.emojiicon.emoji.Objects;
import com.algo.hha.emojiicon.emoji.People;
import com.algo.hha.emojiicon.emoji.Places;
import com.algo.hha.emojiicon.emoji.Symbols;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
	 ...
	 */
	public EmojiconsPopup(View rootView, Context mContext, int rh){
		super(mContext);
		...
		rootView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				int heightDifference = screenHeight
						- (r.bottom - r.top) - reduceHeight;


                //int heightDifference = rootView.getRootView().getHeight() - rootView.getHeight();
