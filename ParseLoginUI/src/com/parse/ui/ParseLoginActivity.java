...
public class ParseLoginActivity extends ActionBarActivity implements
    ...
    private static final String USER_OBJ_ID = "objectId";
    ...
    private static final String BUS_COMPANY_NAME = "busCompanyName";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /******Font Setting*********/
        sharePref = getSharedPreferences(Utils.PREF_SETTING, Context.MODE_PRIVATE);
    ...
    public void onLoginSuccess(ParseUser user) {
        try {
            Intent mDashBoradIntent = new Intent(this, Class.forName("org.undp_iwomen.iwomen.ui.activity.DrawerMainActivity"));
            ...
            Log.e("LogIn User", "==>" + objectId + "/" + username + "/" + ph);
            ...
            if(lang.equals(Utils.ENG_LANG)){
                ...
                mDashBoradIntent.putExtra(Utils.PREF_SETTING_LANG, Utils.MM_LANG);
            }



            //   mDashBoradIntent.putExtra(PASSWORD,password);
            //mDashBoradIntent.putExtra(USER_OBJECT_EMAIL_FIELD,useremail);

            startActivity(mDashBoradIntent);
    ...
    public void onLoginSuccess() {
        ...
        //setResult(RESULT_OK);
        try {
            startActivity(new Intent(this, Class.forName("org.undp_iwomen.iwomen.ui.activity.DrawerMainActivity")));
          /*Intent mDashBoradIntent = new Intent(this,Class.forName("com.questmyanmar.gobus.ui.activity.PaymentActivity"));

          String objectId = user.getObjectId();
          String username = user.getUsername();
          String useremail=   user.getEmail();
          //   String password = user.getString(PASSWORD);
          //String buscompanyname = user.getString(BUS_COMPANY_NAME);
