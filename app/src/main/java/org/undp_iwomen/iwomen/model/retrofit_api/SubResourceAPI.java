...
public class SubResourceAPI {
    private static SubResourceAPI mInstance;
    private SubResourceService mService;


    public SubResourceAPI(){
        ...
        */
        mService = restAdapter.create(SubResourceService.class);
    ...
    public static SubResourceAPI getInstance(){
        if(mInstance == null){
            mInstance = new SubResourceAPI();
        }
        return  mInstance;
    }
    public SubResourceService getService(){
        return mService;
    }
