...
public class LostAPI {
    private static LostAPI mInstance;
    private LostService mService;
    ...
    public LostAPI(){
        ...
        RequestInterceptor requestInterceptor = new RequestInterceptor() {
            ...
            public void intercept(RequestFacade request) {
                request.addHeader("X-Parse-Application-Id","I2khRHKvXrlaIGn4B570MFbnjzXducX90EzGk22S");

                request.addHeader("X-Parse-REST-API-Key", "fvWTlk0jrhFHdlQ8Q8IMBbNpK3zQPRgNZZLYhkzg");
            }
        };
        ...
        */
        mService = restAdapter.create(LostService.class);
    ...
    public static LostAPI getInstance(){
        if(mInstance == null){
            mInstance = new LostAPI();
        }
        return  mInstance;
    }
    public LostService getService(){
        return mService;
    }
